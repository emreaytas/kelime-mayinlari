...
export default function GameInterface({ gameId }) {
  ...
  const confirmMove = async () => {
    ...
    console.log("Is word valid:", wordValid);
    ...
    if (!wordValid) {
      Alert.alert(
        "Geçersiz Kelime",
        `"${currentWord}" kelimesi geçerli değil. Lütfen geçerli bir kelime oluşturun.`
      );
      return;
    }
